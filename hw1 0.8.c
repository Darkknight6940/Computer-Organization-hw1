...
void MartixMulti(int *martix1, int *martix2, int *martixout, MartixProperty martixPro1, MartixProperty martixPro2) {
	...
	{
		printf("input martix error ,matrixPro1 col must equal matrixPro2 row\n");
		return;
	}
...
void PrintMartix(int *martix, MartixProperty martixPro) {
	...
	for (int i = 0; i < martixPro.height; ++i)
	{
		printf("[ ");
		//go through columns
		for (int j = 0; j < martixPro.width; ++j)
		{
